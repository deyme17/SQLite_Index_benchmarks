...
class RectangleGenerator:
    def __init__(self, x_range: Tuple[int, int], y_range: Tuple[int, int]):
        ...
        self.fixed_sizes: List[Tuple[int, int]] = [
            (40, 30), (80, 60), (120, 90), (160, 120), (200, 150),
            (400, 300), (800, 600), (1200, 900), (1600, 1200), (2000, 1500),
            (4000, 3000), (8000, 6000), (12000, 9000), (16000, 12000), (20000, 15000),
            (40000, 30000), (80000, 60000), (120000, 90000), (160000, 120000),
